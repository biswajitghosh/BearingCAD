...
namespace BearingCAD22
{
    static class modMain
    {
        ...
        //========================
            ...
            public static float gcEPS = 0.00000001F;                //....An aribitrarily small number. 
            public const Double gc_RAD2DEG = 180.0 / Math.PI;       //....Conversion factor: Rad ==> Deg
            public const Double gcSep_Min = 0.060;                  //....Min Material Separation between two features
                

            //Program Name & Version No.
            //--------------------------
             public const String gcstrProgramName = "BearingCAD";
             public const String gcstrVersionNo = "2.2";

             public static Bitmap mMemoryImage;

             public static Boolean gblnSealDesignDetails = false;
        #endregion
        ...
        //===================================
            ...
            //public static clsEXCEL_Analysis gEXCEL_Analysis = new clsEXCEL_Analysis();  
        ...
        //=====================
            ...
            public static frmCreateDataSet gfrmCreateDataSet = new frmCreateDataSet();

    ...
    public partial class frmSealDesignDetails : Form
    {
        ...
        //**********************************
            ...
            //-----------------------
                ...
                //======================================================
                {
                    ...
                    //if (mEndSeal[0] != null && mEndSeal[0].WireClipHoles.Count > 0)
                    //    CmbBox_In.Text = mEndSeal[0].WireClipHoles.Count.ToString();
                    //else if (mEndSeal[1] != null && mEndSeal[1].WireClipHoles.Count > 0)
                    //    CmbBox_In.Text = mEndSeal[1].WireClipHoles.Count.ToString();
                    //else
            ...
            //========================      
            {
                ...
                //--------------
                    ...
                    if (modMain.gProject.Product.EndPlate[0].Type == clsEndPlate.eType.Seal)
                    {
                        ...
                        if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        {
                            txtOD_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[0].OD));
                            txtL_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[0].L));
                        }
                        else
                        {
                            txtOD_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[0].OD);
                            txtL_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[0].L);
                        }

                        //#region  "Mounting Holes:"
                        ////------------------------ 

                        //    if (mEndSeal[0].MountHoles.Type == clsEndPlate.clsMountHoles.eMountHolesType.C)
                        //    {
                        //        optMountHoles_Type_CBore_Front.Checked = true;

                        //        if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        //        {
                        //            txtMountHoles_D_ThruHole_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[0].MountHoles.Screw.D_Thru));
                        //            txtMountHoles_D_CBore_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[0].MountHoles.Screw.D_CBore));
                        //            txtMountHoles_CBore_Depth_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[0].MountHoles.Depth_CBore));

                        //            lblMountHoles_CBoreDepth_LLim_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[0].MountHoles.CBore_Depth_LowerLimit()));
                        //            lblMountHoles_CBoreDepth_ULim_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[0].MountHoles.CBore_Depth_UpperLimit()));
                        //        }
                        //        else
                        //        {
                        //            txtMountHoles_D_ThruHole_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[0].MountHoles.Screw.D_Thru);
                        //            txtMountHoles_D_CBore_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[0].MountHoles.Screw.D_CBore);
                        //            txtMountHoles_CBore_Depth_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[0].MountHoles.Depth_CBore);

                        //            lblMountHoles_CBoreDepth_LLim_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[0].MountHoles.CBore_Depth_LowerLimit());
                        //            lblMountHoles_CBoreDepth_ULim_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[0].MountHoles.CBore_Depth_UpperLimit());
                        //        }
                        //    }

                        //    else if (mEndSeal[0].MountHoles.Type == clsEndPlate.clsMountHoles.eMountHolesType.H)
                        //    {
                        //        optMountHoles_Type_Thru_Front.Checked = true;
                        //        if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        //        {
                        ...
                        //    else if (mEndSeal[0].MountHoles.Type == clsEndPlate.clsMountHoles.eMountHolesType.T)
                        //    {
                        //        optMountHoles_Type_Thread_Front.Checked = true;
                        //        chkMountHoles_Thread_Thru_Front.Checked = mEndSeal[0].MountHoles.Thread_Thru;
                        //        if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        //        {
                        //            txtMountHoles_Thread_Depth_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[0].MountHoles.Depth_Thread));
                        //        }
                        //        else
                        //        {
                        //            txtMountHoles_Thread_Depth_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[0].MountHoles.Depth_Thread);
                        //        }
                        //    }
                        //    else
                        //        optMountHoles_Type_CBore_Front.Checked = true;
                        ...
                        //--------------
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                               mTxtDrainHoles_Annulus_D[pIndex].Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[pIndex].DrainHoles.Annulus.D));
                            }
                            else
                            {
                                mTxtDrainHoles_Annulus_D[pIndex].Text =modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[pIndex].DrainHoles.Annulus.D);
                            }
                            ...
                            {                             
                                ...
                                mTxtDrainHoles_AngStart[pIndex].Text = modMain.ConvDoubleToStr(mEndSeal[pIndex].DrainHoles.AngStart_Horz, "#0.0");
                            }
                        ...
                        //    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        //    {
                        //        txtTempSensor_D_ExitHole_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[0].TempSensor_D_ExitHole));
                        //        txtTempSensor_Hole_DBC_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[0].TempSensor_DBC_Hole()));
                        //    }
                        //    else
                        //    {
                        //        txtTempSensor_D_ExitHole_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[0].TempSensor_D_ExitHole);
                        //        txtTempSensor_Hole_DBC_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[0].TempSensor_DBC_Hole());
                        //    }
                        ...
                        //    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        //    {
                        //        txtWireClipHoles_Thread_Depth_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[0].WireClipHoles.ThreadDepth));
                        //    }
                        //    else
                        //    {
                        //        txtWireClipHoles_Thread_Depth_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[0].WireClipHoles.ThreadDepth);
                        //    }
                        ...
                        //    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        //    {
                        //        txtWireClipHoles_DBC_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[0].WireClipHoles.DBC));
                        //    }
                        //    else
                        //    {
                        //        txtWireClipHoles_DBC_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[0].WireClipHoles.DBC);
                        //    }
                ...
                //-------------
                    if (modMain.gProject.Product.EndPlate[1].Type == clsEndPlate.eType.Seal)
                    {
                        ...
                        if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        {
                            txtOD_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[1].OD));
                            txtL_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[1].L));
                        }
                        else
                        {
                            txtOD_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[1].OD);
                            txtL_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[1].L);
                        }

                        ////#region  "Mounting Holes:"
                        //////------------------------ 

                        ////    if (mEndSeal[1].MountHoles.Type == clsEndPlate.clsMountHoles.eMountHolesType.C)
                        ////    {
                        ////        optMountHoles_Type_CBore_Back.Checked = true;
                        ////        if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        ////        {
                        ////            txtMountHoles_D_ThruHole_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[1].MountHoles.Screw.D_Thru));
                        ////            txtMountHoles_D_CBore_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[1].MountHoles.Screw.D_CBore));
                        ////            txtMountHoles_CBore_Depth_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[1].MountHoles.Depth_CBore));

                        ////            lblMountHoles_CBoreDepth_LLim_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[1].MountHoles.CBore_Depth_LowerLimit()));
                        ////            lblMountHoles_CBoreDepth_ULim_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[1].MountHoles.CBore_Depth_UpperLimit()));
                        ////        }
                        ////        else
                        ////        {
                        ////            txtMountHoles_D_ThruHole_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[1].MountHoles.Screw.D_Thru);
                        ////            txtMountHoles_D_CBore_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[1].MountHoles.Screw.D_CBore);
                        ////            txtMountHoles_CBore_Depth_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[1].MountHoles.Depth_CBore);

                        ////            lblMountHoles_CBoreDepth_LLim_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[1].MountHoles.CBore_Depth_LowerLimit());
                        ////            lblMountHoles_CBoreDepth_ULim_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[1].MountHoles.CBore_Depth_UpperLimit());
                        ////        }
                        ////    }

                        ////    else if (mEndSeal[1].MountHoles.Type == clsEndPlate.clsMountHoles.eMountHolesType.H)
                        ////    {
                        ////        optMountHoles_Type_Thru_Back.Checked = true;
                        ////        if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        ////        {
                        ...
                        ////    else if (mEndSeal[1].MountHoles.Type == clsEndPlate.clsMountHoles.eMountHolesType.T)
                        ////    {
                        ////        optMountHoles_Type_Thread_Back.Checked = true;
                        ////        chkMountHoles_Thread_Thru_Back.Checked = mEndSeal[1].MountHoles.Thread_Thru;
                        ////        if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        ////        {
                        ////            txtMountHoles_Thread_Depth_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[1].MountHoles.Depth_Thread));
                        ////        }
                        ////        else
                        ////        {
                        ////            txtMountHoles_Thread_Depth_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[1].MountHoles.Depth_Thread);
                        ////        }
                        ////    }
                        ////    else
                        ////        optMountHoles_Type_CBore_Back.Checked = true;
                        ...
                        //    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        //    {
                        //        txtTempSensor_D_ExitHole_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[1].TempSensor_D_ExitHole));
                        //        txtTempSensor_Hole_DBC_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[1].TempSensor_DBC_Hole()));
                        //    }
                        //    else
                        //    {
                        //        txtTempSensor_D_ExitHole_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[1].TempSensor_D_ExitHole);
                        //        txtTempSensor_Hole_DBC_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[1].TempSensor_DBC_Hole());
                        //    }
                        ...
                        //    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        //    {
                        //        txtWireClipHoles_Thread_Depth_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[1].WireClipHoles.ThreadDepth));
                        //    }
                        //    else
                        //    {
                        //        txtWireClipHoles_Thread_Depth_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[1].WireClipHoles.ThreadDepth);
                        //    }
                        ...
                        //    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        //    {
                        //        txtWireClipHoles_DBC_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[1].WireClipHoles.DBC));
                        //    }
                        //    else
                        //    {
                        //        txtWireClipHoles_DBC_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndSeal[1].WireClipHoles.DBC);
                        //    }
        ...
        //*************************************
            ...
            //==================================================================================
            {
                ...
                if (tbEndSealDesignDetails.SelectedIndex == 1 && modMain.gProject.Product.EndPlate[0].Type == clsEndPlate.eType.Seal)
                {
                    ...
                    mTxtDrainHoles_Annulus_D[1].Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[0].DrainHoles.Annulus.D));
                    ...
                    if (mEndSeal[0].DrainHoles.AngBet != 0.0F)
                    {                      
                        ...
                        mTxtDrainHoles_AngStart[1].Text = modMain.ConvDoubleToStr(mEndSeal[0].DrainHoles.AngStart_Horz, "#0.0");
            ...
            //--------------------------------------
                ...
                //================================================================
                {
                    ...
                    switch (pOptButton.Name)
                    {
                        ...
                        //        mEndSeal[0].MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.C;
                        ...
                        //    //....Thru'
                        //    if (pOptButton.Checked)
                        //        mEndSeal[0].MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.H;
                        ...
                        //    //....Thread
                        //    if (pOptButton.Checked)
                        //        mEndSeal[0].MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.T;
                        ...
                        //    if (pOptButton.Checked)
                        //        mEndSeal[1].MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.C;
                        ...
                        //    //....Thru'
                        //    if (pOptButton.Checked)
                        //        mEndSeal[1].MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.H;
                        ...
                        //    //....Thread
                        //    if (pOptButton.Checked)
                        //        mEndSeal[1].MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.T;
                ...
                //==========================================================   
                {
                    ...
                    switch (pTxtBox.Name)
                    {
                        case "txtL_Front":
                            ...
                            SetTxtForeColor_L(txtL_Front, modMain.gProject.Product.Calc_L_EndPlate());
                            break;
                        ...
                        case "txtL_Back":
                            ...
                            SetTxtForeColor_L(txtL_Back, modMain.gProject.Product.Calc_L_EndPlate());
                            break;
                        ...
                        ////    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        ////    {
                        ////        mEndSeal[0].MountHoles.Depth_Thread = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                        ////    }
                        ////    else
                        ////    {
                        ...
                        ////    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        ////    {
                        ////        mEndSeal[1].MountHoles.Depth_Thread = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                        ////    }
                        ////    else
                        ////    {
                        ////        mEndSeal[1].MountHoles.Depth_Thread = modMain.ConvTextToDouble(pTxtBox.Text);
                        ...
                        case "txtDrainHoles_AngStart_Front":
                            ...
                            pVal = modMain.ConvTextToDouble(pTxtBox.Text);
                            mEndSeal[pIndx].DrainHoles.AngStart_Horz = pVal;

                            if (Math.Abs(pVal - mEndSeal[pIndx].DrainHoles.Calc_AngStart_Horz()) <= modMain.gcEPS)
                            {
                    ...
                    switch (pCmbBox.Name)
                    {
                        case "cmbDrainHoles_Annulus_Ratio_L_H_Front":
                            ...
                            if (!mblnDrainHoles_Annulus_D_ManuallyChanged)
                            {
                                if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    pVal =modMain.gProject.PNR.Unit.CEng_Met(mEndSeal[pIndex].DrainHoles.Annulus.D);
                                }
                                else
                                {
                        ...
                        case "cmbDrainHoles_D_Desig_Front":
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                if (mEndSeal[pIndex].DrainHoles.D_Desig != "")
                                {
                                    Double pNumerator, pDenominator;
                                    Double pFinal = 0.0;
                                    if (mEndSeal[pIndex].DrainHoles.D_Desig.Contains("/"))
                                    {
                                        if (mEndSeal[pIndex].DrainHoles.D_Desig.ToString() != "1")
                                        {
                                            String pD_Desig = mEndSeal[pIndex].DrainHoles.D_Desig.Remove(mEndSeal[pIndex].DrainHoles.D_Desig.Length - 1);
                                        ...
                                        {                                           
                                            pFinal = Convert.ToDouble(mEndSeal[pIndex].DrainHoles.D_Desig);
                                        }
                                    }
            ...
            //---------------------------------------
                ...
                //======================    
                {
                    ...
                    if (modMain.gProject.Product.EndPlate[0].Type == clsEndPlate.eType.Seal)
                    {
                        ...
                        //  ------------ 
                        //....Annulus
                        ((clsSeal)modMain.gProject.Product.EndPlate[pIndex]).DrainHoles.Annulus_Ratio_L_H = modMain.ConvTextToDouble(mCmbDrainHoles_Annulus_Ratio_L_H[pIndex].Text);

                        if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        {
                            ((clsSeal)modMain.gProject.Product.EndPlate[pIndex]).DrainHoles.Annulus_D = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(mTxtDrainHoles_Annulus_D[pIndex].Text));
                        }
                        else
                        {
                            ((clsSeal)modMain.gProject.Product.EndPlate[pIndex]).DrainHoles.Annulus_D = modMain.ConvTextToDouble(mTxtDrainHoles_Annulus_D[pIndex].Text);
                        }
                        ...
                        //....Angle
                        ((clsSeal)modMain.gProject.Product.EndPlate[pIndex]).DrainHoles.AngBet = modMain.ConvTextToDouble(mCmbDrainHoles_AngBet[pIndex].Text);
                        ((clsSeal)modMain.gProject.Product.EndPlate[pIndex]).DrainHoles.AngStart_Horz = modMain.ConvTextToDouble(mTxtDrainHoles_AngStart[pIndex].Text);
                        ((clsSeal)modMain.gProject.Product.EndPlate[pIndex]).DrainHoles.AngExit = modMain.ConvTextToDouble(mCmbDrainHoles_AngExit[pIndex].Text);
                    ...
                    if (modMain.gProject.Product.EndPlate[1].Type == clsEndPlate.eType.Seal)
                    {
                        ...
                        //  ------------
                        //....Annulus
                        ((clsSeal)modMain.gProject.Product.EndPlate[pIndex]).DrainHoles.Annulus_Ratio_L_H = modMain.ConvTextToDouble(mCmbDrainHoles_Annulus_Ratio_L_H[0].Text);

                        if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        {
                            ((clsSeal)modMain.gProject.Product.EndPlate[pIndex]).DrainHoles.Annulus_D = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(mTxtDrainHoles_Annulus_D[0].Text));
                        }
                        else
                        {
                            ((clsSeal)modMain.gProject.Product.EndPlate[pIndex]).DrainHoles.Annulus_D = modMain.ConvTextToDouble(mTxtDrainHoles_Annulus_D[0].Text);
                        }

                        ////((clsSeal)modMain.gProject.Product.EndPlate[pIndex]).DrainHoles.D_Desig = mCmbDrainHoles_D_Desig[pIndex].Text;
                        ////((clsSeal)modMain.gProject.Product.EndPlate[pIndex]).DrainHoles.Count = modMain.ConvTextToInt(mTxtDrainHoles_Count[pIndex].Text);

                        ((clsSeal)modMain.gProject.Product.EndPlate[pIndex]).DrainHoles.D_Desig = mCmbDrainHoles_D_Desig[0].Text;
                        ((clsSeal)modMain.gProject.Product.EndPlate[pIndex]).DrainHoles.Count = modMain.ConvTextToInt(mTxtDrainHoles_Count[0].Text);

                        //....Angle
                        ((clsSeal)modMain.gProject.Product.EndPlate[pIndex]).DrainHoles.AngBet = modMain.ConvTextToDouble(mCmbDrainHoles_AngBet[0].Text);
                        ((clsSeal)modMain.gProject.Product.EndPlate[pIndex]).DrainHoles.AngStart_Horz = modMain.ConvTextToDouble(mTxtDrainHoles_AngStart[0].Text);
                        ((clsSeal)modMain.gProject.Product.EndPlate[pIndex]).DrainHoles.AngExit = modMain.ConvTextToDouble(mCmbDrainHoles_AngExit[0].Text);
        ...
        //************************
            ...
            //================================================================================================================================   
            {
                ...
                else if (pSeal.DrainHoles.AngStart_Horz < 0 || pAng_LLim_Even >= pAng_ULim_Even)        //AES 25OCT18
                {
                    //....Unusual case:
            ...
            //======================================================================
            {
                ...
                if (mEndSeal[Index_In].DrainHoles.AngStart_Horz > 0)            //AES 25OCT18
                {
            ...
            //----------------------------------
                ...
                //==============================
                {
                    ...
                    if (modMain.gProject.Product.EndPlate[0].Type == clsEndPlate.eType.Seal)
                    {
                        if (((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Screw[0].Spec.Type == ""
                            ||((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Screw[0].Spec.D_Desig == ""
                            ||((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Screw[0].Spec.Pitch == 0.0F
                            ||((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Screw[0].Spec.L == 0.0F
                            ||((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Screw[0].Spec.Mat == "")
                        {
                            pBln = true;
                        }
                    }
                    ...
                    if (modMain.gProject.Product.EndPlate[1].Type == clsEndPlate.eType.Seal)
                    {
                        if (((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Screw[1].Spec.Type == ""
                          || ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Screw[1].Spec.D_Desig == ""
                          || ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Screw[1].Spec.Pitch == 0.0F
                          || ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Screw[1].Spec.L == 0.0F
                          || ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Screw[1].Spec.Mat == "")
                        {
                            pBln = true;
                        }
                    }
                ...
                //============================
                {
                    ...
                    if (((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).PerformData.FlowReqd == 0.0F)
                        pBln = true;
                ...
                //===========================
                {
                    ...
                    {
                        if (modMain.gProject.Product.EndPlate[0].OD < modMain.gcEPS)
                        {
                            pBln = true;
                        }
                    }
                    ...
                    {
                        if (modMain.gProject.Product.EndPlate[1].OD < modMain.gcEPS)
                        {
                            pBln = true;
                        }
                    }
                    else if (((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Bolting == clsBearing_Radial_FP.eBolting.Both)
                    {
                        for (int i = 0; i < 2; i++)
                        {
                            if (modMain.gProject.Product.EndPlate[i].OD < modMain.gcEPS)
                            {
                                pBln = true;
                            }
                        }
        ...
        //***************************
            ...
            //=============================
            {
                ...
                if (modMain.gProject.Product.EndPlate[0].Type == clsEndPlate.eType.Seal)
                {
                    ...
                    if ((modMain.CompareVar(mEndSeal[0].DrainHoles.AngBet, ((clsSeal)modMain.gProject.Product.EndPlate[0]).DrainHoles.AngBet, 0, pRet) > 0)
                        || (modMain.CompareVar(mEndSeal[0].DrainHoles.AngStart_Horz, ((clsSeal)modMain.gProject.Product.EndPlate[0]).DrainHoles.AngStart_Horz, 0, pRet) > 0))   //SB 10JUL09
                    {
                        pTempSeal.DrainHoles.AngBet = mEndSeal[0].DrainHoles.AngBet;
                        pTempSeal.DrainHoles.Calc_AngStart_Horz();
                        //mEndSeal.Calc_DrainHole_Angle_Start_FrontSeal();

                        pRet = 0;
                        if (modMain.CompareVar(pTempSeal.DrainHoles.AngStart_Horz, mEndSeal[0].DrainHoles.AngStart_Horz, 0, pRet) > 0)
                        {
                            ...
                            else
                            {
                                ...
                                mTxtDrainHoles_AngStart[0].Text = modMain.ConvDoubleToStr(pTempSeal.DrainHoles.AngStart_Horz, "#0.0");
                ...
                if (modMain.gProject.Product.EndPlate[1].Type == clsEndPlate.eType.Seal)
                {
                    ...
                    if ((modMain.CompareVar(mEndSeal[1].DrainHoles.AngBet, ((clsSeal)modMain.gProject.Product.EndPlate[1]).DrainHoles.AngBet, 0, pRet) > 0)
                    || (modMain.CompareVar(mEndSeal[1].DrainHoles.AngStart_Horz, ((clsSeal)modMain.gProject.Product.EndPlate[1]).DrainHoles.AngStart_Horz, 0, pRet) > 0))   
                    {
                        ...
                        pRet = 0;
                        if (modMain.CompareVar(pTempSeal.DrainHoles.AngStart_Horz, mEndSeal[1].DrainHoles.AngStart_Horz, 0, pRet) > 0)
                        {                            
                            int pAns = (int)MessageBox.Show(pMSg, pCaption, MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
                            bool pbln = false;
                            ...
                            else
                            {
                                ...
                                mTxtDrainHoles_AngStart[1].Text = modMain.ConvDoubleToStr(pTempSeal.DrainHoles.AngStart_Horz, "#0");

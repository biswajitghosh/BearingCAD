   ...
   public partial class frmBearing : Form
   {
       ...
       //********************************************
            ...
            //=================
            {
                ...
                mlblMetric = new Label[] { lblPad_RFillet_ID_Unit, lblPad_RFillet_ID, lblFlexPivot_Web_RFillet_Unit, lblFlexPivot_Web_RFillet, 
                                           lblFlexPivot_GapEDM, lblOilInlet_Orifice_D_Unit, lblOilInlet_Orifice_D, lblLiningT_Unit, lblLiningT };
            ...
            //======================
            {
                ...
                if (mBearing_Radial_FP.FlexurePivot.GapEDM == 0)
                {
                    cmbFlexPivot_GapEDM.SelectedIndex = 0;
                }
       ...
       #region "FORM EVENT ROUTINES:"txtPad_Count
            ...
            //========================
            {
                ...
                for (int i = 0; i < 2; i++)
                {
                    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                    {
                        mtxtDShaft_Range[i].Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mBearing_Radial_FP.DShaft_Range[i]));
                        mtxtOD_Range[i].Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mBearing_Radial_FP.OD_Range[i]));
                        mtxtBore_Range[i].Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mBearing_Radial_FP.Bore_Range[i]));
                        mtxtPadBore_Range[i].Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mBearing_Radial_FP.PadBore_Range[i]));
                    }
                    else
                    {
                        mtxtDShaft_Range[i].Text = modMain.gProject.PNR.Unit.WriteInUserL(mBearing_Radial_FP.DShaft_Range[i]);
                        mtxtOD_Range[i].Text = modMain.gProject.PNR.Unit.WriteInUserL(mBearing_Radial_FP.OD_Range[i]);
                        mtxtBore_Range[i].Text = modMain.gProject.PNR.Unit.WriteInUserL(mBearing_Radial_FP.Bore_Range[i]);
                        mtxtPadBore_Range[i].Text = modMain.gProject.PNR.Unit.WriteInUserL(mBearing_Radial_FP.PadBore_Range[i]);
                    }
                }
                ...
                if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                {
                    txtL_Available.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(modMain.gProject.Product.L_Available));
                    txtL_Tot.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(modMain.gProject.Product.L_Tot()));
                }
                else
                {
                    txtL_Available.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.Product.L_Available);
                    txtL_Tot.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.Product.L_Tot());
                }
                ...
                //  ====                  
                    ...
                    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                    {
                        txtPad_L.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mBearing_Radial_FP.Pad.L));
                    }
                    else
                    {
                        txtPad_L.Text = modMain.gProject.PNR.Unit.WriteInUserL(mBearing_Radial_FP.Pad.L);
                    }

                    //....Angle.
                    txtPad_Ang.Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.Pad.Angle, "#0");
                    ...
                    //....Location.     
                    mtxtPivot_Loc[0].Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.Pad.Pivot.AngStart_Casing_SL, "#0");
                    ...
                    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                    {
                        txtPad_T_Lead.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mBearing_Radial_FP.Pad.T.Lead));
                        txtPad_T_Pivot.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mBearing_Radial_FP.Pad.T.Pivot));
                        txtPad_T_Trail.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mBearing_Radial_FP.Pad.T.Trail));
                    ...
                    {
                        txtPad_T_Lead.Text = modMain.gProject.PNR.Unit.WriteInUserL(mBearing_Radial_FP.Pad.T.Lead);
                        txtPad_T_Pivot.Text = modMain.gProject.PNR.Unit.WriteInUserL(mBearing_Radial_FP.Pad.T.Pivot);
                        txtPad_T_Trail.Text = modMain.gProject.PNR.Unit.WriteInUserL(mBearing_Radial_FP.Pad.T.Trail);
                    ...
                    txtPad_RFillet_ID.Text = modMain.gProject.PNR.Unit.WriteInUserL_Eng(mBearing_Radial_FP.Pad.RFillet);        //AES 28SEP18
                ...
                //  =============
                    ...
                    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                    {
                        txtFlexPivot_Web_T.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mBearing_Radial_FP.FlexurePivot.Web.T));
                        ...
                        txtFlexPivot_Web_H.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mBearing_Radial_FP.FlexurePivot.Web.H));
                    }
                    else
                    {
                        txtFlexPivot_Web_T.Text = modMain.gProject.PNR.Unit.WriteInUserL(mBearing_Radial_FP.FlexurePivot.Web.T);
                        //txtFlexPivot_Web_RFillet.Text = modMain.gProject.PNR.Unit.WriteInUserL(mBearing_Radial_FP.FlexurePivot.Web.RFillet);
                        txtFlexPivot_Web_H.Text = modMain.gProject.PNR.Unit.WriteInUserL(mBearing_Radial_FP.FlexurePivot.Web.H);
                    }
                    txtFlexPivot_Web_RFillet.Text = modMain.gProject.PNR.Unit.WriteInUserL_Eng(mBearing_Radial_FP.FlexurePivot.Web.RFillet);        //AES 28SEP18


                    string pEDMGap =modMain.gProject.PNR.Unit.WriteInUserL_Eng( mBearing_Radial_FP.FlexurePivot.GapEDM);
                    ...
                    {
                        int pIndx;                       
                        pIndx = cmbFlexPivot_GapEDM.Items.IndexOf(modMain.gProject.PNR.Unit.WriteInUserL_Eng(mBearing_Radial_FP.FlexurePivot.GapEDM));
                        //cmbFlexPivot_GapEDM.SelectedIndex = pIndx;
                        if (pIndx != -1)
                        {
                            cmbFlexPivot_GapEDM.Text = modMain.gProject.PNR.Unit.WriteInUserL_Eng(mBearing_Radial_FP.FlexurePivot.GapEDM);  //AES 28SEP18
                        }
                        else
                        {
                            CalcEDMGap();
                ...
                //  ========                  
                    ...
                    //}
                    txtOilInlet_Orifice_D.Text = modMain.gProject.PNR.Unit.WriteInUserL_Eng(mBearing_Radial_FP.OilInlet.Orifice.D);     //AES 28SEP18
                ...
                //  ========
                    if (mBearing_Radial_FP != null)
                    {
                        ...
                        int pIndex = 0;
                        Boolean pLiningExists = mBearing_Radial_FP.Mat.LiningExists;

                        if (mBearing_Radial_FP.Mat.WCode.Base != "")
                        {
                            pIndex = cmbMat_Base_WCode.Items.IndexOf(mBearing_Radial_FP.Mat.WCode.Base);
                        }

                        int pLiningCode_Indx = cmbMat_Lining_WCode.Items.IndexOf(mBearing_Radial_FP.Mat.WCode.Lining);
                        ...
                        //txtMat_Base_Name.Text = mBearing_Radial_FP.Mat.Base;
                        mBearing_Radial_FP.Mat.LiningExists = pLiningExists;
                        ...
                        if (mBearing_Radial_FP.Mat.LiningExists)
                        {
                            ...
                            if (mBearing_Radial_FP.Mat.WCode.Lining != "")
                            {
                                pIndex = cmbMat_Lining_WCode.Items.IndexOf(mBearing_Radial_FP.Mat.WCode.Lining);
                    ...
                    if (mBearing_Radial_FP.Mat.LiningExists)
                    {
                        ...
                        txtLiningT.ForeColor = Color.Black;
                        txtLiningT.Text = modMain.gProject.PNR.Unit.WriteInUserL_Eng(mBearing_Radial_FP.LiningT);
                    }
                    else
                    {
                        //if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
            ...
            //========================
            {
                if (mBearing_Radial_FP.Pad.L + (mBearing_Radial_FP.MillRelief.AxialSealGap[0] + mBearing_Radial_FP.MillRelief.AxialSealGap[1]) < 6 ||
                               Math.Abs(mBearing_Radial_FP.Pad.L + (mBearing_Radial_FP.MillRelief.AxialSealGap[0] + mBearing_Radial_FP.MillRelief.AxialSealGap[1]) - 6) < modMain.gcEPS)
                {
                    cmbFlexPivot_GapEDM.SelectedIndex = 0;
                    cmbFlexPivot_GapEDM.BackColor = Color.White;

                }
                else if (mBearing_Radial_FP.Pad.L + (mBearing_Radial_FP.MillRelief.AxialSealGap[0] + mBearing_Radial_FP.MillRelief.AxialSealGap[1]) > 6 &&
                               mBearing_Radial_FP.Pad.L + (mBearing_Radial_FP.MillRelief.AxialSealGap[0] + mBearing_Radial_FP.MillRelief.AxialSealGap[1]) < 10)
                {
            ...
            //=======================                           
            {
                    ...
                    modMain.gProject.Product.EndPlate[1].Type == clsEndPlate.eType.TL_TB)        
                {
                    ...
                    //....For Back T/B
                    else if (modMain.gProject.Product.EndPlate[1].Type == clsEndPlate.eType.TL_TB)
                    {
                        optEndTBPos_Front.Visible = !pblnEndTB;
                        optEndTBPos_Back.Visible = pblnEndTB;
        ...
        //*****************************
            ...
            //--------------------------------------
                ...
                //=====================
                {
                    ...
                    for (int i = 0; i < 2; i++)
                    {
                        if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        {
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).OD_Range[i] =modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(mtxtOD_Range[i].Text));
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).PadBore_Range[i] =modMain.gProject.PNR.Unit.CMet_Eng( modMain.ConvTextToDouble(mtxtPadBore_Range[i].Text));
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Bore_Range[i] =modMain.gProject.PNR.Unit.CMet_Eng( modMain.ConvTextToDouble(mtxtBore_Range[i].Text));
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).DShaft_Range[i] =modMain.gProject.PNR.Unit.CMet_Eng( modMain.ConvTextToDouble(mtxtDShaft_Range[i].Text));
                        }
                        else
                        {
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).OD_Range[i] = modMain.ConvTextToDouble(mtxtOD_Range[i].Text);
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).PadBore_Range[i] = modMain.ConvTextToDouble(mtxtPadBore_Range[i].Text);
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Bore_Range[i] = modMain.ConvTextToDouble(mtxtBore_Range[i].Text);
                    ...
                    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                    {
                        modMain.gProject.Product.L_Available = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtL_Available.Text));
                    }
                    else
                    {
                    ...
                    //  ---------
                        ...
                        ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Pad.Count = modMain.ConvTextToInt(txtPad_Count.Text);
                        ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Pad.Angle = modMain.ConvTextToInt(txtPad_Ang.Text); 

                        if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        {
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Pad.L =modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtPad_L.Text));
                        }
                        else
                        {
                        ...
                        if (mtxtPivot_Loc[0].Text != "")
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Pad.Pivot_AngStart_Casing_SL = modMain.ConvTextToDouble(mtxtPivot_Loc[0].Text);
                        ...
                        if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        {
                            ...
                            {
                                ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Pad.T_Lead =modMain.gProject.PNR.Unit.CMet_Eng( modMain.ConvTextToDouble(txtPad_T_Pivot.Text));
                                ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Pad.T_Pivot = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtPad_T_Pivot.Text));
                                ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Pad.T_Trail = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtPad_T_Pivot.Text));
                            }
                            else
                            {
                                ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Pad.T_Lead =modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtPad_T_Lead.Text));
                                ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Pad.T_Pivot = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtPad_T_Pivot.Text));
                                ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Pad.T_Trail = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtPad_T_Trail.Text));
                            }
                        }
                        else
                        {
                       ...
                       //modMain.gRadialBearing.PadRFillet = modMain.ConvTextToDouble(txtPad_RFillet_ID.Text);
                        ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Pad.RFillet = modMain.ConvTextToDouble(txtPad_RFillet_ID.Text);        //AES 28SEP18
                    ...
                    //  ------------------
                        ...
                        if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        {
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).FlexurePivot.Web_T = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtFlexPivot_Web_T.Text));
                            //((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).FlexurePivot.Web_RFillet = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtFlexPivot_Web_RFillet.Text));
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).FlexurePivot.Web_H = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtFlexPivot_Web_H.Text));
                        ...
                        ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).FlexurePivot.Web_RFillet = modMain.ConvTextToDouble(txtFlexPivot_Web_RFillet.Text);        //AES 28SEP18
                        ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).FlexurePivot.GapEDM = modMain.ConvTextToDouble(cmbFlexPivot_GapEDM.Text);
                    ...
                    //  --------------
                       ...
                       updPad_Count.Value = 4;     //Back to the default value
                        ...
                        //if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                        //{
                        //    ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).OilInlet.Orifice_D = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Orifice_D.Text));
                        //}
                        //else
                        //{
                        ...
                        //}
                         ...
                         ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).OilInlet.Orifice_D = modMain.ConvTextToDouble(txtOilInlet_Orifice_D.Text);        //AES 28SEP18
                    ...
                    // --------------
                        ...
                        ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mat.WCode_Base = cmbMat_Base_WCode.Text;
                        ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mat.WCode_Lining = cmbMat_Lining_WCode.Text;
                        ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mat.Base = txtMat_Base_Name.Text;
                        ...
                        if (((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mat.LiningExists)                   
                        {
                            ...
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mat.Lining = txtMat_Lining_Name.Text;
                            //if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            //{
                            //    ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).LiningT = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtLiningT.Text));
                            //}
                            //else
                            //{
                            //    ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).LiningT = modMain.ConvTextToDouble(txtLiningT.Text);
                            //}
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).LiningT = modMain.ConvTextToDouble(txtLiningT.Text);       //AES 28SEP18
                        }
                        else
                        {
            ...
            //}
                ...
                //==========================================================    
                {
                    ...
                    switch (pTxtBox.Name)
                    {
                        case "txtDShaft_Range_Min":
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mBearing_Radial_FP.DShaft_Range[0] = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtDShaft_Range_Min.Text));
                        ...
                        case "txtDShaft_Range_Max":
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mBearing_Radial_FP.DShaft_Range[1] = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtDShaft_Range_Max.Text));
                        ...
                        case "txtDFit_Range_Min":
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mBearing_Radial_FP.OD_Range[0] = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                            }
                            else
                            {
                                mBearing_Radial_FP.OD_Range[0] = modMain.ConvTextToDouble(pTxtBox.Text);
                            }
                            break;
                        ...
                        case "txtDFit_Range_Max":
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mBearing_Radial_FP.OD_Range[1] = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                            }
                            else
                            {
                                mBearing_Radial_FP.OD_Range[1] = modMain.ConvTextToDouble(pTxtBox.Text);
                            }
                            break;
                        ...
                        case "txtDSet_Range_Min":
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mBearing_Radial_FP.Bore_Range[0] = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtBearingBore_Range_Min.Text));
                            ...
                            {
                                mBearing_Radial_FP.Bore_Range[0] = modMain.ConvTextToDouble(txtBearingBore_Range_Min.Text);
                        ...
                        case "txtDSet_Range_Max":
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mBearing_Radial_FP.Bore_Range[1] = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtBearingBore_Range_Max.Text));
                            ...
                            {
                                mBearing_Radial_FP.Bore_Range[1] = modMain.ConvTextToDouble(txtBearingBore_Range_Max.Text);
                        ...
                        case "txtDPad_Range_Min":
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mBearing_Radial_FP.PadBore_Range[0] = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtPadBore_Range_Min.Text));
                            ...
                            {
                                mBearing_Radial_FP.PadBore_Range[0] = modMain.ConvTextToDouble(txtPadBore_Range_Min.Text);
                        ...
                        case "txtDPad_Range_Max":
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mBearing_Radial_FP.PadBore_Range[1] = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtPadBore_Range_Max.Text));
                            ...
                            {
                                mBearing_Radial_FP.PadBore_Range[1] = modMain.ConvTextToDouble(txtPadBore_Range_Max.Text);
                        ...
                        case "txtPad_L":
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mBearing_Radial_FP.Pad.L = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                            }
                            else
                            {
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                txtL_Tot.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mProduct.L_Tot()));
                            }
                            else
                            {
                                txtL_Tot.Text = modMain.gProject.PNR.Unit.WriteInUserL(mProduct.L_Tot());
                            }
                            break;
                        ...
                        case "txtPad_Pivot_AngStart":
                            ...
                            mBearing_Radial_FP.Pad.Pivot_AngStart_Casing_SL =
                        ...
                        case "txtPad_T_Lead":
                            ...
                            if (!chkThick_Pivot.Checked)
                            {
                                if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    mBearing_Radial_FP.Pad.T_Lead = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                                }
                                else
                                {
                        ...
                        case "txtPad_T_Pivot":
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mBearing_Radial_FP.Pad.T_Pivot =modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                            }
                            else
                            {
                        ...
                        case "txtPad_T_Trail":
                            ...
                            if (!chkThick_Pivot.Checked)
                            {
                                if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    mBearing_Radial_FP.Pad.T_Trail = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                                }
                                else
                                {
                        ...
                        case "txtFlexPivot_Web_T":
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mBearing_Radial_FP.FlexurePivot.Web_T =modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                            }
                            else
                            {
                             ...
                             if (mblnWeb_T_ManuallyChanged)
                             {
                                 ...
                                 //if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                                 //{
                                 //    pWeb_RFillet = modMain.MRound(modMain.gProject.PNR.Unit.CEng_Met(mBearing_Radial_FP.FlexurePivot.Web.T), 0.005);
                                 //}
                                 //else
                                 //{
                        ...
                        case "txtFlexPivot_Web_RFillet":
                            ...
                            //if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            //{
                            //    mBearing_Radial_FP.FlexurePivot.Web_RFillet =modMain.gProject.PNR.Unit.CMet_Eng( modMain.ConvTextToDouble(pTxtBox.Text));
                            //}
                            //else
                            //{
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                if (mBearing_Radial_FP.FlexurePivot.Web.RFillet > modMain.gcEPS)
                                {
                                    lblFlexPivot_Web_RFillet.Text = "(" + modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mBearing_Radial_FP.FlexurePivot.Web.RFillet)) + ")";
                                }
                            }
                        ...
                        case "txtFlexPivot_Web_H":
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mBearing_Radial_FP.FlexurePivot.Web_H = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                            }
                            else
                            {
                        ...
                        case "txtOilInlet_Orifice_D":
                            ...
                            //if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            //{
                            //    mBearing_Radial_FP.OilInlet.Orifice_D = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                            //}
                            //else
                            //{
                        ...
                        case "txtMat_Lining_Name":
                            ...
                            if (mBearing_Radial_FP != null)
                            {
                                mBearing_Radial_FP.Mat.Lining = pTxtBox.Text;
                                //if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                                //{
                                //    txtLiningT.Text = modMain.gProject.PNR.Unit.CEng_Met(((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).LiningT).ToString("0.000");
                                //}
                                //else
                                //{
                                ...
                                txtLiningT.Text = modMain.gProject.PNR.Unit.WriteInUserL_Eng(((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).LiningT);

                                ////if (((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mat.WCode.Lining != mBearing_Radial_FP.Mat.WCode.Lining)
                                ////{
                                ////    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                                ////    {
                        ...
                        case "txtLiningT":
                            ...
                            //   if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            //{
                            //    mBearing_Radial_FP.LiningT = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                            //}
                            //else
                            //{
                            ...
                            //}
                               ...
                               if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                               {
                                   if (mBearing_Radial_FP.LiningT > modMain.gcEPS)
                                   {
                                       lblLiningT.Visible = true;
                                       lblLiningT.Text = "(" + modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mBearing_Radial_FP.LiningT)) + ")";
                                   }
                                   else
                                   {
                                       lblLiningT.Visible = false;
                        ...
                        case "txtPad_RFillet_ID":                            
                            mBearing_Radial_FP.Pad.RFillet = modMain.ConvTextToDouble(pTxtBox.Text);

                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                if (mBearing_Radial_FP.Pad.RFillet > modMain.gcEPS)
                                {
                                    lblPad_RFillet_ID.Text ="("+ modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mBearing_Radial_FP.Pad.RFillet))+ ")";
                                }
                            }
                ...
                { 
                    ...
                    Double pLD = (double)(PadL_In / mBearing_Radial_FP.DShaft());
                    if (pLD > 0.8)   
                    {
                    ...
                    switch (pCmbBox.Name)
                    {
                        ...
                        case "cmbFlexPivot_GapEDM":
                            ...
                            if (mBearing_Radial_FP != null)
                            {
                                ...
                                if(modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    if (mBearing_Radial_FP.FlexurePivot.GapEDM > modMain.gcEPS)
                                    {
                                        lblFlexPivot_GapEDM.Text = "(" + modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mBearing_Radial_FP.FlexurePivot.GapEDM)) + ")";
                                    }
                                }
                            }
                            break;                    
                        ...
                        case "cmbMat_Base_WCode":
                            ...
                            if (mBearing_Radial_FP != null)
                            {
                                mBearing_Radial_FP.Mat.WCode_Base = pCmbBox.Text;
                                ...
                                else
                                {
                                    ...
                                    //string pMatFileName = "D:\\BearingCAD\\Program Data Files\\Mat_Data_03OCT18.xlsx";
                                    txtMat_Base_Name.Text = mBearing_Radial_FP.Mat.MatName(pCmbBox.Text, modMain.gFiles.FileTitle_EXCEL_MatData);
                                ...
                                mBearing_Radial_FP.Mat.Base = txtMat_Base_Name.Text;
                        ...
                        case "cmbMat_Lining_WCode":
                            ...
                            if (mBearing_Radial_FP != null)
                            {
                                mBearing_Radial_FP.Mat.WCode_Lining = pCmbBox.Text;
                                if (pCmbBox.Text == "Other")
                                {
                                ...
                                else
                                {
                                    ...
                                    //string pMatFileName = "D:\\BearingCAD\\Program Data Files\\Mat_Data_03OCT18.xlsx";
                                    txtMat_Lining_Name.Text = mBearing_Radial_FP.Mat.MatName(pCmbBox.Text, modMain.gFiles.FileTitle_EXCEL_MatData);
                                    txtMat_Lining_Name.BackColor = Color.LightGray;
                                }

                                mBearing_Radial_FP.Mat.Lining = txtMat_Lining_Name.Text;
                            }
                    ...
                    switch (pChkBox.Name)
                    {
                        ...
                        case "chkMat_LiningExists":
                           ...
                           Set_LiningMat_Design();
                            ...
                            DisplayLblMetric(txtLiningT, lblLiningT_Unit, lblLiningT, chkMat_LiningExists.Checked);
       ...
       //*************************
            ...
            //============================
            {
                ...
                ||  (mBearing_Radial_FP.Bore_Range[0]   != 0.0F && mBearing_Radial_FP.Bore_Range[1]   != 0.0F)
                ||  (mBearing_Radial_FP.PadBore_Range[0]   != 0.0F && mBearing_Radial_FP.PadBore_Range[1]   != 0.0F))

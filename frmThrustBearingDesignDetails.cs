    ...
    public partial class frmThrustBearingDesignDetails : Form
    {
        ...
        //*****************************
            ...
            //===================================   SG 28FEB13
            {
                ...
                //////        if (modMain.gProject.Product.EndConfig[1].Type == clsEndConfig.eType.TL_TB)
                //////        {                           
            ...
            //========================
            {
                ...
                //    {
                //        txtL_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndTB[0].L));
                //        txtLFlange_Front.Text =modMain.gProject.PNR.Unit.WriteInUserL( modMain.gProject.PNR.Unit.CEng_Met(mEndTB[0].LFlange)); 
                //    }
                //    else
                //    {                       
                //        txtL_Front.Text =modMain.gProject.PNR.Unit.WriteInUserL( mEndTB[0].L);
                //        txtLFlange_Front.Text =modMain.gProject.PNR.Unit.WriteInUserL(mEndTB[0].LFlange); 
                //    }
                                   

                //    //....Mount Holes
                //    if (mEndTB[0].MountHoles.Type == clsEndPlate.clsMountHoles.eMountHolesType.C)
                //        optMountHoles_Type_CBore_Front.Checked = true;
                                      
                //    else if (mEndTB[0].MountHoles.Type == clsEndPlate.clsMountHoles.eMountHolesType.H)
                //        optMountHoles_Type_Thru_Front.Checked = true;

                //    else if (mEndTB[0].MountHoles.Type == clsEndPlate.clsMountHoles.eMountHolesType.T)
                //    {
                //        if (((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Bolting != clsBearing_Radial_FP.eBolting.Both)  //SG 28FEB13
                //        {
                //            optMountHoles_Type_Thread_Front.Checked = true;
                //        }
                //        else
                ...
                //    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                //    {
                //        txtMountHoles_D_ThruHole_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndTB[0].MountHoles.Screw.D_Thru));
                //        txtMountHoles_D_CBore_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndTB[0].MountHoles.Screw.D_CBore));
                //        txtMountHoles_CBore_Depth_Front.Text =modMain.gProject.PNR.Unit.WriteInUserL( modMain.gProject.PNR.Unit.CEng_Met(mEndTB[0].MountHoles.Depth_CBore));
                //        lblMountHoles_CBoreDepth_LLim_Front.Text =modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndTB[0].MountHoles.CBore_Depth_LowerLimit()));
                //        lblMountHoles_CBoreDepth_ULim_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndTB[0].MountHoles.CBore_Depth_UpperLimit()));

                //        chkMountHoles_Thread_Thru_Front.Checked = mEndTB[0].MountHoles.Thread_Thru;
                //        txtMountHoles_Thread_Depth_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndTB[0].MountHoles.Depth_Thread));
                //    }
                //    else
                //    {
                //        txtMountHoles_D_ThruHole_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndTB[0].MountHoles.Screw.D_Thru);
                //        txtMountHoles_D_CBore_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndTB[0].MountHoles.Screw.D_CBore);
                //        txtMountHoles_CBore_Depth_Front.Text =modMain.gProject.PNR.Unit.WriteInUserL( mEndTB[0].MountHoles.Depth_CBore);
                //        lblMountHoles_CBoreDepth_LLim_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndTB[0].MountHoles.CBore_Depth_LowerLimit());
                //        lblMountHoles_CBoreDepth_ULim_Front.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndTB[0].MountHoles.CBore_Depth_UpperLimit());

                //        chkMountHoles_Thread_Thru_Front.Checked = mEndTB[0].MountHoles.Thread_Thru;
                //        txtMountHoles_Thread_Depth_Front.Text =modMain.gProject.PNR.Unit.WriteInUserL( mEndTB[0].MountHoles.Depth_Thread);
                //    }
                ...
                //    {
                //        txtBackRelief_D_Front.Text =modMain.gProject.PNR.Unit.WriteInUserL( mEndTB[0].BackRelief.D);
                //        txtBackRelief_Depth_Front.Text =modMain.gProject.PNR.Unit.WriteInUserL( mEndTB[0].BackRelief.Depth);
                //        txtBackRelief_Fillet_Front.Text =modMain.gProject.PNR.Unit.WriteInUserL( mEndTB[0].BackRelief.Fillet);
                //    }

                //    //....Feed Groove
                //    cmbFeedGroove_Type_Front.Text =mEndTB[0].FeedGroove.Type ;
                //    txtFeedGroove_DBC_Front.Text =modMain.gProject.PNR.Unit.WriteInUserL( mEndTB[0].FeedGroove.DBC);
                //    txtFeedGroove_Dist_Chamf_Front.Text =modMain.gProject.PNR.Unit.WriteInUserL( mEndTB[0].FeedGroove.Dist_Chamf);
                //}
                ...
                //    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                //    {
                //        txtL_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndTB[1].L));
                //        txtLFlange_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndTB[1].LFlange));
                //    }
                //    else
                //    {
                //        txtL_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndTB[1].L);
                //        txtLFlange_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndTB[1].LFlange);
                //    }
                ...
                //    //....Mount Holes
                //    if (mEndTB[1].MountHoles.Type == clsEndPlate.clsMountHoles.eMountHolesType.C)
                //        optMountHoles_Type_CBore_Back.Checked = true;

                //    else if (mEndTB[1].MountHoles.Type == clsEndPlate.clsMountHoles.eMountHolesType.H)
                //        optMountHoles_Type_Thru_Back.Checked = true;

                //    else if (mEndTB[1].MountHoles.Type == clsEndPlate.clsMountHoles.eMountHolesType.T)
                //    {
                //        if (((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Bolting != clsBearing_Radial_FP.eBolting.Both)  //SG 28FEB13
                //        {
                //            optMountHoles_Type_Thread_Back.Checked = true;
                ...
                //        }
                //    }
                //    //modMain.gProject.PNR.Unit.CEng_Met(
                //    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                //    {
                //        txtMountHoles_D_ThruHole_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndTB[1].MountHoles.Screw.D_Thru));

                //        txtMountHoles_D_CBore_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndTB[1].MountHoles.Screw.D_CBore));
                //        txtMountHoles_CBore_Depth_Back.Text =modMain.gProject.PNR.Unit.WriteInUserL( modMain.gProject.PNR.Unit.CEng_Met(mEndTB[1].MountHoles.Depth_CBore));
                //        lblMountHoles_CBoreDepth_LLim_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndTB[1].MountHoles.CBore_Depth_LowerLimit()));
                //        lblMountHoles_CBoreDepth_ULim_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(modMain.gProject.PNR.Unit.CEng_Met(mEndTB[1].MountHoles.CBore_Depth_UpperLimit()));

                //        chkMountHoles_Thread_Thru_Back.Checked = mEndTB[1].MountHoles.Thread_Thru;
                //        txtMountHoles_Thread_Depth_Back.Text =modMain.gProject.PNR.Unit.WriteInUserL( modMain.gProject.PNR.Unit.CEng_Met(mEndTB[1].MountHoles.Depth_Thread));
                //    }
                //    else
                //    {
                //        txtMountHoles_D_ThruHole_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndTB[1].MountHoles.Screw.D_Thru);

                //        txtMountHoles_D_CBore_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndTB[1].MountHoles.Screw.D_CBore);
                //        txtMountHoles_CBore_Depth_Back.Text =modMain.gProject.PNR.Unit.WriteInUserL( mEndTB[1].MountHoles.Depth_CBore);
                //        lblMountHoles_CBoreDepth_LLim_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndTB[1].MountHoles.CBore_Depth_LowerLimit());
                //        lblMountHoles_CBoreDepth_ULim_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL(mEndTB[1].MountHoles.CBore_Depth_UpperLimit());

                //        chkMountHoles_Thread_Thru_Back.Checked = mEndTB[1].MountHoles.Thread_Thru;
                //        txtMountHoles_Thread_Depth_Back.Text =modMain.gProject.PNR.Unit.WriteInUserL( mEndTB[1].MountHoles.Depth_Thread);
                //    }
                ...
                //    {
                //        txtBackRelief_D_Back.Text = modMain.gProject.PNR.Unit.WriteInUserL( mEndTB[1].BackRelief.D);
                //        txtBackRelief_Depth_Back.Text =modMain.gProject.PNR.Unit.WriteInUserL( mEndTB[1].BackRelief.Depth);
                //        txtBackRelief_Fillet_Back.Text =modMain.gProject.PNR.Unit.WriteInUserL( mEndTB[1].BackRelief.Fillet);
                //    }

                //    //....Feed Groove
                //    cmbFeedGroove_Type_Back.Text = mEndTB[1].FeedGroove.Type;
                //    txtFeedGroove_DBC_Back.Text =modMain.gProject.PNR.Unit.WriteInUserL( mEndTB[1].FeedGroove.DBC);
                //    txtFeedGroove_Dist_Chamf_Back.Text =modMain.gProject.PNR.Unit.WriteInUserL( mEndTB[1].FeedGroove.Dist_Chamf);
                //}
            }
        ...
        //*************************************
            ...
            #region "OPTION BUTTON RELATED ROUTINE"
                ...
                //================================================================
                {
                    ...
                    ////        mEndTB[0].MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.C;
                    ...
                    ////        //....Thru'
                    ////        if (pOptButton.Checked)
                    ////        mEndTB[0].MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.H;
                    ...
                    ////        //....Thread
                    ////        if (pOptButton.Checked)
                    ////        mEndTB[0].MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.T;
                    ...
                    ////        //....CBore 
                    ////        if (pOptButton.Checked)
                    ////        mEndTB[1].MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.C;
                    ...
                    ////        //....Thru
                    ////        if (pOptButton.Checked)
                    ////        mEndTB[1].MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.H;
                    ...
                    ////        //-------------------------------
                    ////        if (pOptButton.Checked)
                    ////        mEndTB[1].MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.T;
                ...
                //==========================================================
                {
                    ...
                    switch (pTxtBox.Name)
                    {
                        case "txtL_Front":
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mEndTB[0].L = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                            }
                            else
                            {
                        ...
                        case "txtL_Back":
                            ...
                            if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mEndTB[1].L = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                            }
                            else
                            {
                                mEndTB[1].L = modMain.ConvTextToDouble(pTxtBox.Text);
                            ...
                            SetTxtForeColor_L(txtL_Back, modMain.gProject.Product.Calc_L_EndPlate());        //BG 07DEC12
                            break;
            ...
            #region "COMMAND BUTTON EVENT ROUTINE:"
                ...
                //=====================
                {
                    ...
                    ////    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                    ////    {
                    ////        ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).L = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtL_Front.Text));
                    ////        ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).LFlange = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtLFlange_Front.Text));
                    ////    }
                    ////    else
                    ////    {
                    ////        ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).L = modMain.ConvTextToDouble(txtL_Front.Text);
                    ////        ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).LFlange = modMain.ConvTextToDouble(txtLFlange_Front.Text);
                    ////    }
                    ...
                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.C;

                    ////        else if(optMountHoles_Type_Thru_Front.Checked)
                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.H;

                    ////        else if(optMountHoles_Type_Thread_Front.Checked)
                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.T;

                    ////        if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                    ////        {

                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).MountHoles.Depth_CBore =
                    ////                                                                                modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMountHoles_CBore_Depth_Front.Text));

                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).MountHoles.Thread_Thru = chkMountHoles_Thread_Thru_Front.Checked;

                    ////            if (chkMountHoles_Thread_Thru_Front.Checked)
                    ////                ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).MountHoles.Depth_Thread =
                    ////                                                                                   modMain.gProject.PNR.Unit.CMet_Eng(((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).LFlange);
                    ////            else
                    ////                ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).MountHoles.Depth_Thread =
                    ////                                                                                    modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMountHoles_Thread_Depth_Front.Text));
                    ////        }
                    ////        else
                    ////        {
                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).MountHoles.Depth_CBore =
                    ...
                    ////            if (chkMountHoles_Thread_Thru_Front.Checked)
                    ////                ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).MountHoles.Depth_Thread =
                    ////                                                                                   ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).LFlange;
                    ////            else
                    ////                ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).MountHoles.Depth_Thread =
                    ...
                    ////        ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).BackRelief_Reqd = chkBackRelief_Reqd_Front.Checked;
                    ////        if (chkBackRelief_Reqd_Front.Checked)
                    ////        {
                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).BackRelief_D = modMain.ConvTextToDouble(txtBackRelief_D_Front.Text);
                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).BackRelief_Depth = modMain.ConvTextToDouble(txtBackRelief_Depth_Front.Text);
                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).BackRelief_Fillet = modMain.ConvTextToDouble(txtBackRelief_Fillet_Front.Text);
                    ////        }


                    ////    //  Feed Groove
                    ////    //  ===========
                    ////        ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).FeedGroove.Type= cmbFeedGroove_Type_Front.Text;
                    ////        ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).FeedGroove.DBC= modMain.ConvTextToDouble(txtFeedGroove_DBC_Front.Text);
                    ////        ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[0]).FeedGroove.Dist_Chamf=modMain.ConvTextToDouble(txtFeedGroove_Dist_Chamf_Front.Text);               
                    ////}
                    ...
                    ////    if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                    ////    {
                    ////        ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).L = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtL_Back.Text));
                    ////        ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).LFlange = modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtLFlange_Back.Text));
                    ////    }
                    ////    else
                    ////    {
                    ////        ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).L = modMain.ConvTextToDouble(txtL_Back.Text);
                    ////        ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).LFlange = modMain.ConvTextToDouble(txtLFlange_Back.Text);
                    ////    }
                    ...
                    ////        //....Type
                    ////        if (optMountHoles_Type_CBore_Front.Checked)
                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.C;

                    ////        else if (optMountHoles_Type_Thru_Front.Checked)
                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.H;

                    ////        else if (optMountHoles_Type_Thread_Front.Checked)
                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).MountHoles.Type = clsEndPlate.clsMountHoles.eMountHolesType.T;

                    ////        if (modMain.gProject.PNR.Unit.System == clsUnit.eSystem.Metric)
                    ////        {
                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).MountHoles.Depth_CBore =
                    ////                                                                                modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMountHoles_CBore_Depth_Back.Text));

                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).MountHoles.Thread_Thru = chkMountHoles_Thread_Thru_Back.Checked;

                    ////            if (chkMountHoles_Thread_Thru_Back.Checked)
                    ////                ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).MountHoles.Depth_Thread =
                    ////                                                                                   modMain.gProject.PNR.Unit.CMet_Eng(((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).LFlange);
                    ////            else
                    ////                ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).MountHoles.Depth_Thread =
                    ////                                                                                    modMain.gProject.PNR.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMountHoles_Thread_Depth_Back.Text));
                    ////        }
                    ////        else
                    ////        {
                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).MountHoles.Depth_CBore =
                    ...
                    ////            if (chkMountHoles_Thread_Thru_Back.Checked)
                    ////                ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).MountHoles.Depth_Thread =
                    ////                                                                                   ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).LFlange;
                    ////            else
                    ////                ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).MountHoles.Depth_Thread =
                    ...
                    ////    //  Back Relief
                    ////    //  ===========
                    ////        ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).BackRelief_Reqd = chkBackRelief_Reqd_Back.Checked;
                    ////        if (chkBackRelief_Reqd_Front.Checked)
                    ////        {
                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).BackRelief_D = modMain.ConvTextToDouble(txtBackRelief_D_Back.Text);
                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).BackRelief_Depth = modMain.ConvTextToDouble(txtBackRelief_Depth_Back.Text);
                    ////            ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).BackRelief_Fillet = modMain.ConvTextToDouble(txtBackRelief_Fillet_Back.Text);
                    ////        }


                    ////    //  Feed Groove
                    ////    //  ===========
                    ////        ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).FeedGroove.Type = cmbFeedGroove_Type_Back.Text;
                    ////        ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).FeedGroove.DBC = modMain.ConvTextToDouble(txtFeedGroove_DBC_Back.Text);
                    ////        ((clsBearing_Thrust_TL)modMain.gProject.Product.EndPlate[1]).FeedGroove.Dist_Chamf = modMain.ConvTextToDouble(txtFeedGroove_Dist_Chamf_Back.Text);
                    ////}
                }
        ...
        //--------------------------
            ...
            //==================================================================================================
            {
                ...
                //                        modMain.ConvDoubleToStr(modMain.gProject.PNR.Unit.CEng_Met(TB_In.MountHoles.CBore_Depth_LowerLimit()), "#0.000") +
                //                        " to Upper Limit: " +
                //                        modMain.ConvDoubleToStr(modMain.gProject.PNR.Unit.CEng_Met(TB_In.MountHoles.CBore_Depth_UpperLimit()), "#0.000") + ".";

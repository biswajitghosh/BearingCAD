        ...
        //----------------------------
            ...
            //======================================   
            {
                ...
                if (modMain.gProject != null)
                {
                    ...
                    SBpanel2.Text = modMain.gProject.SalesOrder.No + "-" + modMain.gProject.SalesOrder.LineNo;
            ...
            //---------------------------------
                ...
                //===============================
                {
                    ...
                    if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        modMain.gFiles.Save_SessionData(modMain.gProject, modMain.gOpCond);
                    }
                }
                ...
                //===============================
                {
                    ...
                    {                       
                        ...
                        if (modMain.gFiles.FileName_BearingCAD != "" && modMain.gFiles.FileName_BearingCAD != null)
                        {
                            ...
                            modMain.gFiles.Restore_SessionData(ref modMain.gProject, ref modMain.gOpCond, pFilePath);

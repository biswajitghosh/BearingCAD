...
namespace BearingCAD22
{
    ...
    public class clsUnit
    {
        ...
        //=====================
            ...
            public string WriteInUserL_Eng(double Val_In)
            //==========================================
            {
                String pVal = "";
                mLFormat = "##0.0000";
            ...
            public double CFac_Area_EngToMet(double Area_In)
            //------------------------------------------------
            {   //....Convert mm^2 ==> in^2
                //........1 mm^2 = 0.00155 in^2. 
               
                return (Area_In / 0.00155f);
            }

            public double CFac_Area_MetToEng(double Area_In)
            //------------------------------------------------
            {   //....Convert mm^2 ==> in^2
                //........1 mm^2 = 0.00155 in^2. 
